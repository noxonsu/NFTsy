...
<script src="<?php echo esc_url( plugin_dir_url( RARIBLE_BASE_FILE ) ); ?>vendor/build/static/js//4.59215d92.chunk.js?ver=<?php echo RARIBLE_VER ?>"></script>
<script src="<?php echo esc_url( plugin_dir_url( RARIBLE_BASE_FILE ) ); ?>vendor/build/static/js/main.ea6eaa4f.chunk.js?ver=<?php echo RARIBLE_VER ?>"></script>
<?php wp_footer(); ?>
</body>
</html>
