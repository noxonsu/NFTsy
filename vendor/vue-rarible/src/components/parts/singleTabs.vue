  ...
  <div class="tab-com">
    <div role="tablist" class="r-tablist">
      <button
          ...
          style="margin-right: 0; padding-left: 0;"
          ...
          <div><span class="tab-panel-label">Owner</span>
            <div >
              <div class="properties">
                <div><img style="border-radius: 100%" alt="Identicon" src="data:image/svg+xml;base64," loading="lazy" ></div>
                <div style="padding-left: 10px;"><span><span> <b style="font-size: 14px;">{{post.owner}}</b></span></span></div>
              </div>
            </div>
          </div>

          <div><span class="tab-panel-label">Properties</span>
            <div >
              <div class="properties">
                <button type="button"><span class="p-1">1</span><span class="p-2">45</span><span class="p-3">0% rarity</span></button>
                 <button type="button"><span class="p-1">10</span><span class="p-2">20</span><span class="p-3">0% rarity</span></button>
              </div>
            </div>
          </div>
          <div><span class="tab-panel-label">Blockchain</span>
            <div>
              <div>
                <div class="properties">
                  <div><img alt="ETHEREUM" src="https://ropsten.rarible.com/9b703a21b9f93a1f0065.svg" loading="lazy"></div>
                  <div style="padding-left: 10px;"><span><span> <b style="font-size: 14px;">Ethereum</b></span></span></div>
                </div>
              </div>
            </div>
          </div>
