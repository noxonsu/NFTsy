  ...
  <div ref="container" id="picture-input" class="picture-input">
    ...
    <div v-else-if="supportsPreview">
      <div class="preview-container" style="position: relative"
        ...
        <button v-if="imageSelected" @click.prevent="removeImage" :class="removeButtonClass">x</button>
...
<!--      <button v-if="imageSelected && removable" @click.prevent="removeImage" :class="removeButtonClass">x</button>-->
